...
<div id="newsletter_contents">
	...
	<div id="newsletter_container">
	    <span class="register_title">Gelişmelerden haberdar olmak için e-posta grubumuza kayıt olun</span>
	    <input name="email" id="e_mail" placeholder="E-Posta Adresiniz" type="text">
	    <button id="register" type="submit">Kayıt Ol</button>
	    <div class="social_buttons_holder">
	        ...
	        <a target="_blank" href="https://plus.google.com/TheGardrobe"><span class='symbol googleplus'>circlegoogleplus</span></a>
	        <a target="_blank" href="http://www.instagram.com/TheGardrobe"><span class='symbol instagram'>circleinstagram</span></a>
	    </div>
	</div>

	<div id="successful_container">
	    <i class="fa fa-check"></i>
	    <span class="register_title success">Başarıyla Kayıt Oldunuz!</span>
